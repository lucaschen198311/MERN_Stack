...
const addNewRestaurant = (req, res) => {
  ...
  // validate uniqueness
  // Restaurant.findOne({ name: body.name })
  //   .then((restaurant) =>
  //     res.status(400).json({ errorMsgUnique: "Restaurants must be unique" })
  //   )
  //   .catch((err) => console.log("restaurant not found"));
  // console.log("JKLJLKJLKJLKJKL");
  // we have to feed the mongoose create function an array for the dishes field.
  // So, we pull off the dishes keys from the body obj
...
const deleteRestaurant = (req, res) => {
  ...
  console.log("upppppppjkljlkjlkjklj");
