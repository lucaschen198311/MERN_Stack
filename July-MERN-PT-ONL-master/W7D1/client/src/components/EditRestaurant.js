  ...
  useEffect(() => {
    axios
      ...
      .then((queriedRestaurant) => {
        ...
        if (queriedRestaurant.data.restaurant.dishes[0]) {
          setDishOne(queriedRestaurant.data.restaurant.dishes[0]);
        }
        if (queriedRestaurant.data.restaurant.dishes[1]) {
          setDishTwo(queriedRestaurant.data.restaurant.dishes[1]);
        }
        if (queriedRestaurant.data.restaurant.dishes[2]) {
          setDishThree(queriedRestaurant.data.restaurant.dishes[2]);
        }
      })
