...
const RestaurantForm = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios
      ...
      .then((newRestaurant) => {
        console.log("THEN BLOCK", newRestaurant);
  ...
  return (
    <>
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div>
          <label htmlFor="dishOne">Dish One</label>
          <input
            type="text"
            name="dishOne"
        ...
        <div>
          <label htmlFor="dishTwo">Dish Two</label>
          <input
            type="text"
            name="dishTwo"
        ...
        <div>
          <label htmlFor="dishThree">Dish Three</label>
          <input
            type="text"
            name="dishThree"
      ...
      <button onClick={() => handleClick("ex")} disabled={decideIfDisabled()}>
        CLICK ME!!
      </button>
      {/* 
