    ...
    <div>
        <div className={styles.header}>
            ...
            <div className={styles.navbar}>
                ...
                <Link className={styles.navlink} to={"/home/admin/new-product"}>Add Product</Link>
          ...
          products.map((product, index) => (
            ...
            <div className={styles.card} key={index}>
              ...
              <div className={styles.cardBottom}>
                  <button className={styles.prodBtn} onClick={()=>handleAddToCart(product._id)}>Add to cart</button>
                  <Link className={styles.prodLink} to={`/home/admin/edit-product/${product._id}`}>Edit</Link>
              </div>
            </div> ) : null
          ))}
      </div>
